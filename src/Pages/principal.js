                ...
                <div className="row align-items-stretch feature-2">
                  ...
                  <div className="col-lg-3 feature-2-contents pl-lg-5">
                    <div className="fixed-content">
                      ...
                      <h3 className="mb-5">Featured title name here</h3>
                ...
                <div className="row justify-content-center text-center">
                  <div className="col-md-7">
                    <blockquote className="testimonial-1">
                      ...
                      <cite><span className="text-black">Mike Dorney</span> &mdash; <span className="text-muted">CEO and Co-Founder</span></cite>
                    </blockquote>
                  </div>
                </div>
              </div>
