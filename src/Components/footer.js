          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-7">
                ...
                <p>
                  “Desarrollar personas íntegras, con espíritu de servicio
                  misionero e innovadoras a fin de restaurar la imagen de Dios
                  en el ser humano.”
                </p>
              </div>
        ...
        <div className="row pt-5 mt-5 text-center">
          <div className="col-md-12">
            <div className="border-top pt-5">
              <p>
                Copyright 2020 &copy;
                <script type="44bcf6ecc84568d1bf8bf9de-text/javascript">
